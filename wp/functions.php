...
if ( ! function_exists( 'solovki_setup' ) ) :
	function solovki_setup() {
		...
		register_nav_menus( array(
			...
			'bot-nav-1' => esc_html__( 'Bottom Menu About', 'solovki' ),
			'bot-nav-2' => esc_html__( 'Bottom Menu Social', 'solovki' ),
			'bot-nav-3' => esc_html__( 'Bottom Menu Materials', 'solovki' ),
			'bot-nav-4' => esc_html__( 'Bottom Menu Partners', 'solovki' ),
		) );
...
function solovki_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'solovki' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'solovki' ),
