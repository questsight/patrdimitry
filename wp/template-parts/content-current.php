<section id="post-<?php the_ID(); ?>" class="section single">
  ...
  <div class="section__footer single__footer">
    <div class="wrapper">
      ...
      <p class="single__help text-center"><?php the_title(); ?> получает жизненно необходимый квалифицированный уход. Оплата труда сестер милосердия происходит в основном за счет пожертвований. Поддержите нашу службу, чтобы подопечные и дальше получали профессиональный уход.</p>
      <div class="button-group text-center"><a class="button button_bg_accent button_size_large" href="https://miloserdie.help/donate/?item=1350" target="_blank" onclick="yaCounter37338160.reachGoal('order_current'); return true;">Поддержать службу</a></div>
      <div class="single__line"></div>
    </div>
    <div class="wrapper">
